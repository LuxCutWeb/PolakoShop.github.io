...
class App {
    ...
    async init() {
        ...
        onAuthStateChanged(auth, async (user) => {
            if (user) {
                ...
                this.isAdmin = profile && profile.role === "admin";
    ...
    renderHome() {
        ...
        const homeCats = ["Polos", "Casacas", "Hoodies", "Jeans", "Zapatillas", "Gorras"];
    ...
    getCategoryEmoji(cat) {
        const map = {
            "Polos": "👕", "Casacas": "🧥", "Hoodies": "🧥", "Pantalones": "👖", 
            "Jeans": "👖", "Zapatillas": "👟", "Gorras": "🧢", "Mochilas": "🎒"
        };
        return map[cat] || "🏷️";
    }
